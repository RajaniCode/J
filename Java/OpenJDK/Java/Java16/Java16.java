...
class Java16 {
	...
	System.out.printf("Java Version: %s%n%n", System.getProperty("java.version"));
        ...
        ForeignLinkerAPIIncubator incubatorForeignLinkerAPI = new ForeignLinkerAPIIncubator();
	incubatorForeignLinkerAPI.invoker();
	...
	// Java 16 Preview
        /*
        SealedClient clientSealed = new SealedClient();
	clientSealed.print();
        */
    }
}
...
// # 1 # 389: Foreign Linker API (Incubator)
// javac --add-modules jdk.incubator.foreign Java16.java
// java --add-modules jdk.incubator.foreign -Dforeign.restricted=permit Java16
...
// # 3 # 395: Records
// Java 16
// Java 15 Preview, Java 14 Preview
// javac -Xlint:preview --enable-preview -source 14 Java14.java
// javac -Xlint:preview --enable-preview -source 15 Java14.java
// java --enable-preview Java14
...
class SealedClient {
    public void print() { 
        ...
        SealedTypePermitter permitterSealedType = new SealedTypePermitter();
        System.out.println(permitterSealedType.getClass());
        System.out.println(permitterSealedType.getClass().isSealed());
        System.out.println();

        SubSealedTypePermitted permittedSubSealedType = new SubSealedTypePermitted();
        System.out.println(permittedSubSealedType.getClass());
        System.out.println(permittedSubSealedType.getClass().isSealed());
        System.out.println();

        SubSealedTypePermittedHavingSubType havingSubTypeSubSealedTypePermitted = new SubSealedTypePermittedHavingSubType();
        ...
        SubSealedTypePermittedHavingSubTypeExtended havingSubTypeExtendedSubSealedTypePermitted = new SubSealedTypePermittedHavingSubTypeExtended();
...
1 warning
rajaniapple@Rajanis-MacBook-Pro Java16 % java --add-modules jdk.incubator.foreign -Dforeign.restricted=permit Java16
WARNING: Using incubator modules: jdk.incubator.foreign
Java Version: 16.0.2

# 1 # 389: Foreign Linker API (Incubator)
/Users/rajaniapple/Desktop/GitHub/OpenJDK/Java/OpenJDK/Java/Java16/msys64-mingw64.so
Hello, World!
